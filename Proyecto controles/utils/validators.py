...
def canonicalize(label: str) -> str:
    """Convierte label a formato canónico para comparación, reparando doble encodificación UTF-8 si existiera."""
    if label is None:
        return ""
    
    s = str(label)
    
    # Intentar reparar doble codificación UTF-8 (ej: bytes utf-8 leídos como latin-1)
    try:
